...
def ShanghaiTechCampus_frames_labels(root_path = 'DATASET/' ):
    label_list_path = os.path.join(root_path, 'test/test_frame_mask' )
...
def gather_datasets_labels(root_path='/mnt/data/DataSet/datasets/', dataset='shanghai_tech'):
    ...
    datasets_labels['UIT_ADrone_Snow'] = ShanghaiTechCampus_frames_labels

    #datasets_labels['UIT_DroneAnomaly_Foggy'] = ShanghaiTechCampus_frames_labels
    #datasets_labels['UIT_ADrone_Foggy'] = ShanghaiTechCampus_frames_labels
