...
class VisionTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        # ResNet
        self.effnet = timm.create_model('efficientnet_b0', num_classes=0, pretrained=False)
        self.effnet.global_pool = self.effnet.classifier
        self.projection = nn.Linear(1280, emb_dim)
