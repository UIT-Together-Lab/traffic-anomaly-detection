...
def get_train_config():
    ...
    parser.add_argument("--model-arch", type=str, default="b16", help='model setting to use', choices=['b16', 'b32', 'l16', 'l32', 'h14'])
    parser.add_argument("--checkpoint-path", type=str, default="experiments_UIT_ADrone_original/checkpoints/best.pth", help="model checkpoint to load weights")
    ...
    parser.add_argument("--train-steps", type=int, default=200000, help="number of training/fine-tunning steps")
